...
<div id="plcenter" style="border:1px solid red; border-radius:10px;width:auto;">
	...
	<div class="single_header">
		...
		<div class="single_info">
			<span style="float:right;padding-right:100px;">文章来源：
...
<!-- 			<span>发布者： <?php the_author(); ?></span>  -->
			<span>发布时间： <?php the_time('Y年m月d日G:i:s');?> </span>
		</div>
