...
?>
<div class="catetory_content">
    <ul>
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    
        <li><a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>">video_up<?php the_title(); ?></a></li>
    
    <?php endwhile; ?>
    <!-- ，如果没有就显示“文章稍后更新”. -->
    <?php else: ?> 
        <div class="post"><p>文章稍后更新video</p></div>
    <?php endif; ?>
    </ul>
            ...
            <div class="category_content_video" style="min-height:30px;height:100%;padding-bottom:20px;">
                ...
                <ul>';
                    foreach($posts as $post){
                        ...
                        <a title="'.$post->post_title.'" href="'.get_permalink($post->ID).'">video'.$post->post_title.'</a></li>';
                    }
                echo '</ul>
            </div>';
        }
